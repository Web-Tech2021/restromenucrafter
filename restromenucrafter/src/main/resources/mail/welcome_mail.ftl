																...
																<td>
																	<table border="0" cellpadding="0" cellspacing="0"
																		...
																		<tbody>
																			...
																			<tr>
																				<td
																					style="font-family:Lato, Arial, sans-serif, Trebuchet MS; font-size:16px; line-height:26px; color:#616161; text-align: center;">
																					Let's build a digital menu using our
																					tool. This eliminates the need for
																					physical menus and enhances the
